% dual_sided_prelim         extracts waveforms for two sets of channels during one clu
...
% 24-jun-20 added testing of cc for sync vs. non-sync snippets

% to do: 
% remove spikes during stims
% change AnatGrps to SpkGrps for chans2

function [ dspks1, dspks2, pvals, st1, st2 ] = dual_sided_prelim( filebase, shankclu1, shankclu2, slct1, slct2 )% look at 1.2 and 4.11 in mDS1_08
...
% plot them
figure, plot_ss( filebase, shankclu1 ), title( 'pre-synaptic (trigger)' )
figure, plot_ss( filebase, shankclu2 ), title( 'post-synaptic (triggered)' )

% now get the spike times of the trigger
...
filebase = filebase_lookup( 'mDS1_08' );
shankclu1 = [ 4 9 ];
shankclu2 = [ 3 6 ];
slct1 = 16;
slct2 = 16;
...
[ dspks1, dspks2, pvals, st1, st2 ] = dual_sided_prelim( filebase, shankclu2, shankclu1, slct1, slct2 );
