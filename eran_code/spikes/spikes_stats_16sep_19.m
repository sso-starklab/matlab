...
[ shanknums, clunums, clustr, plotflag, Overwrite, periods, blockwise, byPar, doFET ] = ParseArgPairs( ...
    { 'shanknums', 'clunums', 'clustr', 'plotflag', 'Overwrite', 'periods', 'blockwise', 'byPar', 'doFET' } ...
    , { [], [], 'clu', 0, -2, -1, 1, 0, 1 }...
    , varargin{ : } );
SaveFn                          = [ filebase '.sst' ];
...
for shanknum                    = ushanks
    ...
    for clunum                  = shankclus
        ...
        [ geo_com, geo_sd ]     = calc_com( ( 1 : nchans_all( shanknum ) )', sum( mspk.^2, 2 ) );   % spike COM and spatial dispersion
