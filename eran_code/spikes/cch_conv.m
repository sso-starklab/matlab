...
% 17-oct-20 added support for non-linear filtering
% 20-nov-21 added support for hollowed median filtering (requires external routine medfilt)
% 21-nov-21 added rounding to integer after computing predictor but before
%               estimating Poisson-based probabilities
...
%    pred                = medfilt1( CCH, W, 'truncate' );                  % non-linear filtering
    pred                = medfilt( CCH, W, HF );                            % hollowed non-linear filtering with edge mirroring
else
