% MAKE_SPK_FILE         and detrend; optionally subsample
%
% CALL                  [ RC, SPK ] = MAKE_SPK_FILE( SOURCEFNAME, SPKFNAME, RES, NCHANNELS, CHANNELS )
%
...
%                       CHANNELS        for which to extract the waveforms
%
...
%                       IND             {[]}; source channels for each spike
%
...
function [ rc, spk ] = make_spk_file( sourcefname, spkfname, res, nchannels, channels, varargin )
