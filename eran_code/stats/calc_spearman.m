...
%                   pval    p-value
%
% calls             calc_pearson, mixmat, rankcols
%
...
% revisions
% 01-may-13 (1) take care of NaNs
%           (2) compute significance by resampling (only for 2 columns)
% 26-mar-15 (1) significance should be <= (not <..)
% 12-dec-19 (1) cleaned up
