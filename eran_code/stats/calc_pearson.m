...
%                   Y       optional; then computes the CC between columns of X
%                           and Y
%
...
% revisions
% 18-may-04 extension to column-wise pairs
% 12-jul-04 empty Y supported; auto-columns extended to all pairs
% 08-dec-04 extra line removed
% 12-mar-05 numerator zero -> cc DEFINED as zero.
% 13-feb-07 nansum instead of sum
% 19-mar-07 prevent divide by zero (for two matrices)
% 05-aug-07 nansum should be called with one argument only
% 08-may-13 nan handling perfected..
