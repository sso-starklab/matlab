...
[ shankclu0, fpeth, sgain, pAct ] = seqsort( r2, r3, 'cmp', 'intersect', 'graphics', 1 );
...
figure, 
%subplot( 2, 2, 3 )
%[ ~, ~, rh ] = seqrast( clu, res, periods, 'map', map, 'shankclu', shankclu );
%clf, 
[ ~, ~, rh, ah ] = seqrast( clu, res, periods( 1 : 50 : end, : ), 'map', map, 'shankclu', shankclu, 'stimes', r2.stimes );
