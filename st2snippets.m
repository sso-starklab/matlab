...
%
% GETS                          filebase            full path for data, requires dat file
%                               shankclu1           cluster numbers; either a 2-element vector or a two-row matrix,
%                                                   [ shank1 clu1; shank2 clu2 ]
%                               shankclu2           same as shankclu1
%
% OPTIONAL ARGUMENTS (given as name/value pairs):
%                               halfWidthMS         {1.5}; [ms] window of wide-band data during shankclu1 events
%                               graphics            {1}; plot 
%                               nplot               {100}; number of events taken for graphics
%
% CALLS                         LoadXml
...
% (2) determines a single channel for COM of shankclu2 (channel2)
% (3) extracts wide-band data from channel2 during shankclu1 spikes (requires halfWidthMS)
% (4) determines for each event whether there is a shankclu2 spike
% 
