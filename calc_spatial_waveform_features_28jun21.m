...
% 28-jun-21 (1) changed everything completely
%           (2) including the graphics

% shirly - rewrite all the help and the description of the metrics and the
% algorithm
...
% keep only cases in which positive extremum preceeds negative
kmat( pT > nT, : )              = NaN;
...
% determine the BPI (vB) according to the channel with the maximal p2p
bpi                             = vB( maxidx );
