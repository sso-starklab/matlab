...
% 14-jan-21 (1) added output structure for fig. 2
...
rez = cell( 4, 1 );
for clunum = 1 : 4
    rez{ clunum } = make_punits_figures( 2, 'clustRunMode', [], 'clunum', clunum, 'savef', 0 );
end

make_punits_figures( 2, 'metaplot', 1, 'rez', rez );
