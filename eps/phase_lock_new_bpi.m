          ...
          if lock && isequal(state,'induced')
            ...
            for i = 1:length(uniq_depth)
                ...
                binned_struct.SEMPhaseInt(i) = calc_sem(sst.mPhase(idx3&idxI&~isbip&~ispos&~sst.pyr));   
                    ...
                    binned_struct.mPhaseMBip(i) = nanmean(sst.mPhase(idx3&idxI&isbip&idx_bpi_mult));
                    binned_struct.SEMPhaseMBip(i) = calc_sem(sst.mPhase(idx3&idxI&isbip&idx_bpi_mult));
                    binned_struct.mPhaseNBip(i) = nanmean(sst.mPhase(idx3&idxI&isbip&~idx_bpi_mult));
                    binned_struct.SEMPhaseNBip(i) = calc_sem(sst.mPhase(idx3&idxI&isbip&~idx_bpi_mult));
                    % mean preffered phases of biphasic who are place cells
                    binned_struct.mPhasePBip(i) = nanmean(sst.mPhase(idx3&idxI&isbip&idx_bpiplace));
                    binned_struct.SEMPhasePBip(i) = calc_sem(sst.mPhase(idx3&idxI&isbip&idx_bpiplace));
                    binned_struct.mPhaseNPBip(i) = nanmean(sst.mPhase(idx3&idxI&isbip&~idx_bpiplace));
                    binned_struct.SEMPhaseNPBip(i) = calc_sem(sst.mPhase(idx3&idxI&isbip&~idx_bpiplace));                    
                ...
                binned_struct.pval_PYRMbpi(i) = utest( sst.mPhase(idx3&idxI&isbip&idx_bpi_mult),sst.mPhase(idx3&idxI&~isbip&~ispos&sst.pyr));
                binned_struct.pval_PYRNbpi(i) = utest( sst.mPhase(idx3&idxI&isbip&~idx_bpi_mult),sst.mPhase(idx3&idxI&~isbip&~ispos&sst.pyr));
                binned_struct.pval_PYRPbpi(i) = utest( sst.mPhase(idx3&idxI&isbip&idx_bpiplace),sst.mPhase(idx3&idxI&~isbip&~ispos&sst.pyr));
                binned_struct.pval_PYRNPbpi(i) = utest( sst.mPhase(idx3&idxI&isbip&~idx_bpiplace),sst.mPhase(idx3&idxI&~isbip&~ispos&sst.pyr));

                binned_struct.pval_PYRpos(i) = utest( sst.mPhase(idx3&idxI&ispos),sst.mPhase(idx3&idxI&~isbip&~ispos&sst.pyr));
                binned_struct.rpval_PYRpos(i) = utest( sst.rPhase(idx3&idxI&ispos),sst.rPhase(idx3&idxI&~isbip&~ispos&sst.pyr));
