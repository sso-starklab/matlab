...
% 11-aug-20 (1) moved regions cell arrays to be constants (out of fig.2)
...
if isempty( outdir ) || ~exist( outdir, 'dir' )
    ...
    elseif ispc     % shirly (nanna) Windows
        ...
        fname_hadas         = 'TPR_TPP_data_27-Jul-2020_2';
    end
end
...
reg_nCX      = { 'mA234_01','mA234_03','mA234_07','mA234_08','mA234_09', 'mA234_12', 'mA234_13',...
                 ...
                 'mC41_13', 'mDL5_05', 'mDL5_06', 'mDL5_07', 'mDL5_08','mDL5_09','mDL5_10',...
                 'mDS1_07', 'mDS1_08', 'mDS1_09', 'mF105_10', 'mF108_01','mF108_02',...
...
reg_WM       = { 'mP23_05', 'mP23_06', 'mC41_19', 'mDL5_18'};
...
reg_OTHER     = {'mDL5_11','mDL5_12','mDL5_13','mDL5_14','mDL5_15', 'mDL5_16', 'mDL5_17', 'mDL5_24', ...
                 'mDL5_28','mDL5_31', 'mDL5_32', 'mDL5_33', 'mDL5_34', 'mDL5_36', 'mDS1_10','mP20_07',...
...
if fignums( 4 )
    ...
    for spi             = 1 : nregs
        ...
        idx1            = ismember( sst1.filebase, list1 );
        sstlist         = struct_select( sst1, idx1 );
    ...
    % ACH COM
        ...
        ispos                   = sstlist.extremum > 0;
        nbins                   = 60;
        byprob                  = 0;
        subplot( 2, 2, 1 )
        [ myus, sds, pval, bins_x, hx0, hx1, lh ] = make_punits_figures_one_hist( sstlist.ach_com, ispos, nbins, colors_NP, 'ACH-COM [ms]', byprob );
        lh.String{ 1 }          = 'Punits'; 
        lh.String{ 2 }          = 'Nunits';

        subplot( 2, 2, 2 )
        sst2                    = struct_select( sstlist, ~ispos );
        [ myus, sds, pval, bins_x, hx0, hx1, lh ] = make_punits_figures_one_hist( sst2.ach_com, sst2.shankclu( :, 3 ) == 1, nbins, colors_PI, 'ACH-COM [ms]', byprob );
        lh.String{ 1 }          = 'INT'; 
        lh.String{ 2 }          = 'PYR';
        ...
        byprob                  = 1;
        subplot( 2, 2, 3 )
        sst1i                   = struct_select( sstlist, ispos );
        [ myus, sds, pval, bins_x, hx0, hx1, lh ] = make_punits_figures_one_hist( sst1i.ach_com, true( sum( ispos ), 1 ), nbins, colors_NP, 'ACH-COM [ms]', byprob );
        [ myus, sds, pval, bins_x, hx0, hx1, lh ] = make_punits_figures_one_hist( sst2.ach_com, sst2.shankclu( :, 3 ) == 1, nbins, colors_PI, 'ACH-COM [ms]', byprob );
        lh.String{ 1 }          = 'INT'; 
        lh.String{ 2 }          = 'PYR';
        ...
        pvals                   = Tmc( :, 6 );
        cnames                  = { 'INT-PYR', 'INT-Punits', 'PYR-Punits' };
        title( sprintf( '%s: %0.2g; %s: %0.2g; %s: %0.2g, region: %s', cnames{ 1 }, pvals( 1 ) ...
            , cnames{ 2 }, pvals( 2 ), cnames{ 3 }, pvals( 3 ),reg_names{spi} ) )
