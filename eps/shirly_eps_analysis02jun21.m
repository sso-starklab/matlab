...
subplot( 3, 3, 1 );
[ amp_myus, amp_sds, amp_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.maxp2p, isbip, nbins, colors, 'Amps [mV]', byprob );
subplot( 3, 3, 2 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.maxp2p .* ( 2 * ispos - 1 ), isbip, nbins, colors, 'Signed Amp [mV]', byprob );
subplot( 3, 3, 3 );
[ t2p_myus, t2p_sds, t2p_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.tp, isbip, nbins, colors, 'T2P [ms]', 1 );
subplot( 3, 3, 4 );
[ wid_myus, wid_sds, wid_pval, bins_x, hx0, hx1 ] = make_one_hist( 1 ./ sst.fmax * 1000, isbip, nbins, colors, 'Width [ms]', 1 );
subplot( 3, 3, 5 );
[ gsd_myus, gsd_sds, gsd_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.geo_sd, isbip, nbins, colors, 'Geo-SD [sites]', byprob );
subplot( 3, 3, 6 );
[ fwh_myus, fwh_sds, fwh_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.geo_fwhm, isbip, nbins, colors, 'Geo-FWHM [sites]', byprob );


subplot( 3, 3, 7 );
[ asy_myus, asy_sds, asy_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.asy, isbip, nbins, colors, 'Assymetry', byprob );
subplot( 3, 3, 8 );
[ bst_myus, bst_sds, bst_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.brst, isbip, nbins, colors, 'Burst', byprob );


subplot( 3, 3, 7 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.bpi, isbip, nbins, colors, 'BPI', 1 );
subplot( 3, 3, 8 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.tV, isbip, nbins, colors, 'tV [ms]', byprob );
subplot( 3, 3, 9 );
[ acm_myus, acm_sds, acm_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.ach_com, isbip, nbins, colors, 'ACH-COM [ms]', byprob );
