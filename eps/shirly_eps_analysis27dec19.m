...
subplot( 3, 3, 1 );
[ amp_myus, amp_sds, amp_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.maxp2p, ispos, nbins, colors, 'Amps [mV]' );
subplot( 3, 3, 2 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.maxp2p .* ( 2 * ispos - 1 ), ispos, nbins, colors, 'Signed Amp [mV]' );
subplot( 3, 3, 3 );
[ t2p_myus, t2p_sds, t2p_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.tp, ispos, nbins, colors, 'T2P [ms]' );
subplot( 3, 3, 4 );
[ wid_myus, wid_sds, wid_pval, bins_x, hx0, hx1 ] = make_one_hist( 1 ./ sst.fmax * 1000, ispos, nbins, colors, 'Width [ms]' );
subplot( 3, 3, 5 );
[ gsd_myus, gsd_sds, gsd_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.geo_sd, ispos, nbins, colors, 'Geo-SD [sites]' );
subplot( 3, 3, 6 );
[ fwh_myus, fwh_sds, fwh_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.geo_fwhm, ispos, nbins, colors, 'Geo-FWHM [sites]' );


subplot( 3, 3, 7 );
[ asy_myus, asy_sds, asy_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.asy, ispos, nbins, colors, 'Assymetry' );
subplot( 3, 3, 8 );
[ bst_myus, bst_sds, bst_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.brst, ispos, nbins, colors, 'Burst' );


subplot( 3, 3, 7 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.bpi, ispos, nbins, colors, 'BPI' );
subplot( 3, 3, 8 );
[ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( sst.tV, ispos, nbins, colors, 'tV [ms]' );
subplot( 3, 3, 9 );
[ acm_myus, acm_sds, acm_pval, bins_x, hx0, hx1 ] = make_one_hist( sst.ach_com, ispos, nbins, colors, 'ACH-COM [ms]' );
...
function [ myus, sds, pval, bins_x, hx0, hx1 ] = make_one_hist( x, tidx, nbins, colors, str )
