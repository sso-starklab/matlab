...
function [units_used,lag,widfwhm,asg,delay,delay2,totdelay,pv,IQR] = eps_connectivity2 (Nunit_type,unit_type, varargin)
units_used = [];
lag = [];
widfwhm = [];
asg = [];
...
[ graphics, Multimodal,monotype]      = ParseArgPairs( ...
    { 'graphics', 'Multimodal', 'monotype'} ...
    , { 0, 0 ,'exc'}...
    , varargin{ : } );
