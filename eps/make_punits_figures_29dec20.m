...
%     sstP                    = struct_select( sstP, cidx );
%     sst                     = struct_cat( sstN, sstP );
end
...
%                     'mK01_10','mK01_13', 'mK01_14', 'mK01_16'     
    ...
    reg_SUB        = { 'mDL5_25', 'mDL5_26', 'mDL5_27', 'mDL5_29'};           
    ...
    reg_OTHER     = {'mDL5_11','mDL5_12','mDL5_13','mDL5_14','mDL5_15', 'mDL5_16', 'mDL5_17', 'mDL5_24', ...
...
%        title( sprintf( '%0.2g%%', sums)
    ...
    reg_names           = { 'nCX', 'CA1', 'WM', 'SUB', 'OTHER', 'HPC' };
...
%     end
    ...
    fig5( 1:14 ) = make_PUNIT_figures(1:14);
