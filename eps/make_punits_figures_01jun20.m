...
%     mono1           = check_mono( L1.s2s, gidx );
    ...
    set( gca, 'XTickLabel', colnames )
    set( gca, 'tickdir', 'out', 'box', 'off' )
    ylabel( 'Number of post-synaptic peers' )
    title( 'Number of post-synaptic peers for E (excitatory) and I (inhibitory), units' )
    ...
    set( gca, 'XTickLabel', colnames )
    set( gca, 'tickdir', 'out', 'box', 'off' )
    ylabel( 'Number of pre-synaptic peers' )
    title( 'Number of pre-synaptic peers for E (excitatory) and I (inhibitory), units' )
